...
const PROJECTS = [
  ...
  { num:"02", title:"TundraScout", kind:"Native iOS · App Store", year:"2024",
    blurb:"Match data, team analytics, and offline-first storage in a clean SwiftUI interface — shipped to the App Store.",
    ...
    outcome:"Designed, built, and published to the App Store as sole developer — used by my own team through a full competition season.",
  ...
  { num:"06", title:"Agentic stock model", kind:"NC State · finance AI", year:"2025",
    blurb:"An ML pipeline exploring market signals with logistic regression and random forests.",
    slot:"bcs-stock", slotHint:"Drop a results chart",
    problem:"Market-signal claims are everywhere and almost none survive an honest train/test split.",
    approach:"A pandas feature pipeline feeding logistic regression and random-forest classifiers, evaluated with proper holdout periods rather than in-sample accuracy.",
    outcome:"Built during an NC State winter research program; the useful result was learning how quickly apparent signal disappears under honest evaluation.",
    stack:["scikit-learn","pandas","Python"], links:[] },
