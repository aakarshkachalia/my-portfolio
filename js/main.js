...
const PROJECTS = [
  ...
  { num:"03", title:"AI Carbon Footprint Tracker", kind:"Research · NYAS", year:"2025-26",
    ...
    outcome:"Presented as part of a New York Academy of Sciences research program, and became the groundwork for later research into scheduling AI workloads around cleaner grid windows.",
  ...
  { num:"05", title:"Agentic trading research", kind:"NC State · AI in finance", year:"2026",
    ...
    approach:"Built closely with my professor in the NC State Research High School Program: a multi-agent system running on Ollama locally and wired to the Alpaca API for paper trading, where separate agents handle analysis, portfolio activation, and execution across the S&P 500. A pandas feature pipeline with logistic-regression and random-forest baselines keeps the agents honest. The agreeability work probes the same model with overshoot scenarios framed different ways and measures how far its answer moves with the framing rather than with the data.",
